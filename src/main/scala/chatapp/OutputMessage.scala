...
sealed trait OutputMessage derives Encoder.AsObject
...
case class SuccessfulRegistration(user: User, msg: String = "") extends OutputMessage
...
case class UnsupportedCommand(user: Option[User],msg: String = "Unsupported command") extends OutputMessage
